...
var $author$project$Main$Model = function (times) {
	return {times: times};
};
var $author$project$Main$init = _Utils_Tuple2(
	$author$project$Main$Model($krisajenkins$remotedata$RemoteData$Loading),
	$elm$core$Platform$Cmd$none);
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$core$Platform$Sub$none = $elm$core$Platform$Sub$batch(_List_Nil);
var $author$project$Main$ResultReceived = function (a) {
	return {$: 'ResultReceived', a: a};
};
...
var $author$project$Main$timeDecoder = $elm$json$Json$Decode$list(
	A2($elm$json$Json$Decode$field, 'timeToStation', $elm$json$Json$Decode$int));
var $author$project$Main$getArrivalTime = $elm$http$Http$get(
	{
		expect: A2(
			$elm$http$Http$expectJson,
			A2($elm$core$Basics$composeR, $krisajenkins$remotedata$RemoteData$fromResult, $author$project$Main$ResultReceived),
	...
	function (msg, model) {
		if (msg.$ === 'ResultReceived') {
			...
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{times: $krisajenkins$remotedata$RemoteData$Loading}),
				$author$project$Main$getArrivalTime);
		}
	});
...
var $author$project$Main$parseError = function (err) {
	switch (err.$) {
		case 'Timeout':
			return 'The service timed out';
		case 'NetworkError':
			return 'There was some sort of network error';
		case 'BadUrl':
			return 'There was a bad url error';
		case 'BadStatus':
...
var $author$project$Main$pad = A2(
	...
	A2(
		...
		2,
		_Utils_chr('0')));
var $author$project$Main$timeToBus = function (t) {
	var s = $author$project$Main$pad(60 % t);
	var m = $author$project$Main$pad((t / 60) | 0);
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('minutes')
			]),
		_List_fromArray(
			[
				$elm$html$Html$text(m + ('m:' + (s + 's')))
			]));
};
var $author$project$Main$view = function (model) {
	var _v0 = function () {
		...
		switch (_v1.$) {
			case 'NotAsked':
				return _Utils_Tuple3('Refresh', _List_Nil, '');
			case 'Loading':
				return _Utils_Tuple3('Loading', _List_Nil, '');
			case 'Failure':
				var err = _v1.a;
				return _Utils_Tuple3(
					'Refresh',
					_List_Nil,
					$author$project$Main$parseError(err));
			default:
				var t = _v1.a;
				return _Utils_Tuple3('Refresh', t, '');
		}
	}();
	var txt = _v0.a;
	var data = _v0.b;
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$elm$html$Html$div,
				_List_Nil,
				A2($elm$core$List$map, $author$project$Main$timeToBus, data)),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
						...
						_Utils_eq(model.times, $krisajenkins$remotedata$RemoteData$Loading))
					]),
				_List_fromArray(
					[
						A2(
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"RemoteData.WebData":{"args":["a"],"type":"RemoteData.RemoteData Http.Error a"}},"unions":{"Main.Msg":{"args":[],"tags":{"ResultReceived":["RemoteData.WebData (List.List Basics.Int)"],"Refresh":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Basics.Int"],"BadBody":["String.String"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"List.List":{"args":["a"],"tags":{}},"RemoteData.RemoteData":{"args":["e","a"],"tags":{"NotAsked":[],"Loading":[],"Failure":["e"],"Success":["a"]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});
...
},{"./Main.elm":"Main.elm"}],"../../../.npm-global/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
